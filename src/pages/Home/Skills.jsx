              ...
              <>
                <h3 className="subskill-title">
                  {activeSubSkill.iconType === "svg" ? (
                    ...
                    <i className={activeSubSkill.icon} />
                  )}
                  {activeSubSkill.name}
                </h3>
