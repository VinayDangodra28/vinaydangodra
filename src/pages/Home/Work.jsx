      ...
      <div className="work-frame">
        <div className="work-section">
          ...
          <div className="work-wrapper">
            ...
            {/* GitHub */}
              <a href="https://github.com/VinayDangodra28/" target="_blank" className="work-card big-attract" id="github-work" onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}>
                <div className="circle" style={{ top: `${circlePosition.y}px`, left: `${circlePosition.x}px` }} />
